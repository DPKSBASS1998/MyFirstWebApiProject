        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatingForce = table.Column<int>(type: "int", nullable: true),
                    TotalTravel = table.Column<int>(type: "int", nullable: true),
                    PreTravel = table.Column<int>(type: "int", nullable: true),
                    TactilePosition = table.Column<int>(type: "int", nullable: true),
                    TactileForce = table.Column<int>(type: "int", nullable: true),
                    ImagePath = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    PinCount = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
